...
# Create Movie objects with individual movie information
...
kubo = media.Movie("Kubo and the Two Strings",
                   "A young boy named Kubo must locate a magical suit of "
                   "armor worn by his late father in order to defeat a "
                   "vengeful spirit from the past.",
                   "https://upload.wikimedia.org/wikipedia/en/c/c4/"
                   "Kubo_and_the_Two_Strings_poster.png",
...
# Add each movie object to movies list
